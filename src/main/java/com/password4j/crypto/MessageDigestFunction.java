...
public class MessageDigestFunction extends AbstractHashingFunction
{
    ...
    protected Hash internalHash(CharSequence plainTextPassword, String salt)
    {
        try
        {
            ...
            byte[] result = messageDigest.digest(P4jUtils.fromCharSequenceToBytes(finalCharSequence));
            return new Hash(this, P4jUtils.toHex(result), result, salt);
        }
    ...
    private CharSequence concatenateSalt(CharSequence plainTextPassword, CharSequence salt)
    {
        ...
        {
            return P4jUtils.append(salt, plainTextPassword);
        }
        return P4jUtils.append(plainTextPassword, salt);
    }
