...
public class PBKDF2Function extends AbstractHashingFunction
{
            ...
            int length) throws NoSuchAlgorithmException, InvalidKeySpecException
    {
        ...
        return internalHash(P4jUtils.fromCharSequenceToChars(plainTextPassword), P4jUtils.fromCharSequenceToBytes(salt), algorithm,
                iterations, length);
    }
    ...
    public Hash hash(CharSequence plainTextPassword)
    {
        ...
        return hash(plainTextPassword, P4jUtils.fromBytesToString(salt));
    }
    ...
    {
        return P4jUtils.encodeBase64(encodedKey);
    }
