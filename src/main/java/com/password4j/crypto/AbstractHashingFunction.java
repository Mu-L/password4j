...
public abstract class AbstractHashingFunction implements HashingFunction
{
    ...
    {
        return slowEquals(P4jUtils.fromCharSequenceToBytes(a), P4jUtils.fromCharSequenceToBytes(b));
    }
    ...
    {
        CharSequence peppered = P4jUtils.append(pepper, plainTextPassword);
        Hash result;
        if (salt == null)
        {
    ...
    {
        return check(P4jUtils.append(pepper, plainTextPassword), hashed, salt);
    }
