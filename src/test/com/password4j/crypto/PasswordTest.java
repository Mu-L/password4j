...
public class PasswordTest
{
    ...
    public void testConfigurablePepper()
    {
        ...
        // THEN
        Assert.assertEquals(P4jPropertyReader.readString("global.pepper", null, null), hash.getPepper());
        assertTrue(result);
    }
    ...
    {
        // GIVEN
        P4jPropertyReader.properties.put("global.random.strong", "true");
        ...
        P4jPropertyReader.properties.put("global.random.strong", "false");
    ...
    public void testRawCheck1SecureString()
    {
        ...
        // THEN
        assertTrue(strategy.check(P4jUtils.append(PEPPER, SECURE_PASSWORD), hashed));
    ...
    public void testHmac()
    {
        ...
        {
            Assert.assertEquals("Hmac" + hmac.name(), hmac.toString());
        }
    ...
    public void testGenericUpdate5()
    {
        ...
        Assert.assertEquals(P4jPropertyReader.readString("global.pepper", null, null), updateFixedSaltPepper.getHash().getPepper());
