...
public class Argon2FunctionTest
{
    ...
    public void testAccessors()
    {
        ...
        // THEN
        assertEquals(memory, argon2Function.getMemory());
        assertEquals(iterations, argon2Function.getIterations());
        assertEquals(parallelism, argon2Function.getParallelism());
        assertEquals(outputLength, argon2Function.getOutputLength());
        Assert.assertEquals(variant, argon2Function.getVariant());
        assertEquals(version, argon2Function.getVersion());

        assertEquals("Argon2Function[m=3, i=5, p=7, l=11, t=D, v=13]", argon2Function.toString());
    }
