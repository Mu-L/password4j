...
public class MessageDigestFunctionTest
{
    ...
    public void testMDWrongSaltOption()
    {
        ...
        P4jPropertyReader.properties.setProperty("hash.md.salt.option", "1234");
    ...
    public void testCompressed()
    {
        ...
        for (int i = 1; i <= 100; i++)
        {
            ...
            String expected = "$" + algorithm.code() + "$" + params + "$" + Base64.getEncoder().encodeToString(salt.getBytes(
                    P4jUtils.DEFAULT_CHARSET)) + "$" + notCompressedHash.getResult();
