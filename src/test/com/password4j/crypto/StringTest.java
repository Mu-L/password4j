...
public class StringTest
{
    ...
    public void testConstructors()
    {
        ...
        Assert.assertEquals(Arrays.toString(new char[] { 'b', 'c', 'd' }),
                Arrays.toString(P4jUtils.fromCharSequenceToChars(sub1)));
        Assert.assertEquals(Arrays.toString(P4jUtils.fromCharSequenceToChars(sub1)),
                Arrays.toString(P4jUtils.fromCharSequenceToChars(sub2)));
    ...
    public void testClear()
    {
        ...
        Assert.assertEquals(Arrays.toString(new char[] { z, z, z, z }), Arrays.toString(P4jUtils.fromCharSequenceToChars(ss)));
    }
    ...
    public void testEquality()
    {
        ...
        SecureString ss = new SecureString(password);
        SecureString ss2 = (SecureString) P4jUtils.append(ss, "123");
    ...
    {
        char[] c1 = P4jUtils.fromCharSequenceToChars(null);
        char[] c2 = P4jUtils.fromCharSequenceToChars(new String(new char[0]));
        byte[] b1 = P4jUtils.fromCharSequenceToBytes(null);
        byte[] b2 = P4jUtils.fromCharSequenceToBytes(new String(new char[0]));
        byte[] b3 = P4jUtils.fromCharSequenceToBytes(new String(new char[]{(char)1}));

        CharSequence cs1 = P4jUtils.append("a", null);
        CharSequence cs2 = P4jUtils.append(null, "b");

        CharSequence a1 = P4jUtils.append(new SecureString(new char[] { 'a', 'b', 'c' }), "def");
        CharSequence a2 = P4jUtils.append(null, "def");
        CharSequence a3 = P4jUtils.append(new SecureString(new char[0]), "def");
        CharSequence a4 = P4jUtils.append("abc", null);
        CharSequence a5 = P4jUtils.append("abc", new SecureString(new char[0]));
        ...
        Assert.assertEquals(Arrays.toString(new char[] { 'a', 'b', 'c', 'd', 'e', 'f' }),
                Arrays.toString(P4jUtils.fromCharSequenceToChars(a1)));
        Assert.assertEquals(Arrays.toString(new char[] { 'd', 'e', 'f' }),
                Arrays.toString(P4jUtils.fromCharSequenceToChars(a2)));
        Assert.assertEquals(Arrays.toString(new char[] { 'd', 'e', 'f' }),
                Arrays.toString(P4jUtils.fromCharSequenceToChars(a3)));
        Assert.assertEquals(Arrays.toString(new char[] { 'a', 'b', 'c' }),
                Arrays.toString(P4jUtils.fromCharSequenceToChars(a4)));
        Assert.assertEquals(Arrays.toString(new char[] { 'a', 'b', 'c' }),
                Arrays.toString(P4jUtils.fromCharSequenceToChars(a5)));
    }
}
